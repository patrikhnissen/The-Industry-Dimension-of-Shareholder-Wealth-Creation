...
def compute_wealth_creation(df):
    ...
    print("Shumway delisting imputation applied")
    print("="*65)
...
def table6_bessembinder_style(stock_df, df_monthly):
    ...
    summary.to_csv("table_shumway_90_24.csv", index=False)
    print("Saved: table_shumway_90_24.csv")

    return summary

# TABLE: WITHIN-INDUSTRY CONCENTRATION
def table7_within_industry_concentration(stock_df):
    ...
    print("\n" + "="*115)
    print("TABLE: WITHIN-INDUSTRY WEALTH CREATION CONCENTRATION")
    print("Shumway delisting imputation applied")
    print("="*115)
    ...
    result.to_csv("table_shumway_90_24.csv", index=False)
    print("Saved: table_shumway_90_24.csv")

    return result

# TABLE: RETURN DISTRIBUTION BY INDUSTRY
def table8_return_distribution(stock_df):
    ...
    print("\n" + "="*95)
    print("TABLE: RETURN DISTRIBUTION BY INDUSTRY")
    print("Shumway delisting imputation applied")
    print("="*95)
...
def figure2_return_distributions(stock_df):
    ...
    ax.set_title(
        ...
        'Full sample 1990-2024. Shumway delisting imputation applied. ',
        fontsize=11, color='#2c2c2c', pad=12
    )

    plt.tight_layout()
    fig.savefig("figure_shumway_return_distributions.png", dpi=200, bbox_inches='tight')
    plt.close(fig)
    print("Saved: figure_shumway_return_distributions.png")
...
if __name__ == '__main__':
    ...
    print("\nDone. Outputs:")
    print("  table_shumway_90_24.csv")
    print("  table_shumway_90_24.csv")
    print("  table_shumway_90_24.csv")
    print("  figure_shumway_return_distributions.png")