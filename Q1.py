...
def table6_bessembinder_style(stock_df, df_monthly):
    ...
    summary.to_csv("table2_industry_wc_bessembinder_style_90_24.csv", index=False)
...
def table7_within_industry_concentration(stock_df):
    ...
    result.to_csv("table2_within_industry_concentration_90_24.csv", index=False)
...
def table8_return_distribution(stock_df):
    ...
    result.to_csv("table2_return_distribution_90_24.csv", index=False)
    print("Saved: table2_return_distribution_90_24.csv")
...
def figure2_return_distributions(stock_df):
    ...
    plt.tight_layout()
    fig.savefig("figure2_return_distributions.png", dpi=200, bbox_inches='tight')
    plt.close(fig)
...
def figure5_lottery_vs_yield(stock_df):
    ...
    plt.tight_layout()
    fig.savefig("figure2_lottery_vs_yield.png", dpi=200, bbox_inches='tight')
    plt.close(fig)
    print("Saved: figure2_lottery_vs_yield.png")
...
def figure_appendix_all_industries(stock_df):
    ...
    plt.tight_layout()
    fig.savefig("figure2_appendix_all_industries_wc.png",
                dpi=200, bbox_inches='tight')
    plt.close(fig)
    print("Saved: figure2_appendix_all_industries_wc.png")
